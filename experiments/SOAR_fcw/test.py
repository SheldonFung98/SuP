...
def make_parser():
    ...
    parser.add_argument('--benchmark', choices=['3DMatch', '3DLoMatch', 'val', 'first', 'second', 'third', 'forth'], help='test benchmark')
...
class Tester(SingleTester):
    ...
    def after_test_step(self, iteration, data_dict, output_dict, result_dict):
        ...
        np.savez_compressed(
            ...
            all_est_transform=release_cuda(output_dict['estimated_transforms']),
            sel_est_transform=release_cuda(output_dict['sel_estimated_transform']),
            all_weights=release_cuda(output_dict['all_weights']),
